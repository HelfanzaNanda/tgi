  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        ...
        @if ($user->can('request_inventories.add'))
          ...
          <div class="modal-body">
            ...
            <div>
              ...
              <select name="status" class="form-control" id="input-status">
                ...
                <option value="requested">Pengajuan</option>
...
@section('script')
  <script type="text/javascript">
    ...
    $(document).on("click", "a#edit-data",function(e) {
      ...
      let id = $(this).data('id');
      $.ajax({
        url: BASE_URL+"/api/request_inventories/"+id,
        type: 'GET',
        "headers": {
          'Authorization': TOKEN
        },
    ...
    function drawDatatable() {
      $("#main-table").DataTable({
        ...
        // "ordering": false,
        "ajax":{
            "url": BASE_URL+"/api/request_inventory_datatables",
            "headers": {
              'Authorization': TOKEN
            },
            "dataType": "json",
  ...
  $( 'form#main-form' ).submit( function( e ) {
    ...
    $.ajax({
      type: 'post',
      url: BASE_URL+"/api/store_request_inventories",
      "headers": {
        'Authorization': TOKEN
      },
      data: form_data,
  ...
  $(document).on('click', 'a#delete-data', function( e ) {
    e.preventDefault();
    let id = $(this).data('id');
    showDeletePopup(BASE_URL + '/api/request_inventories/' + id, TOKEN, '', '#main-table', '');
  });
  </script>
@endsection