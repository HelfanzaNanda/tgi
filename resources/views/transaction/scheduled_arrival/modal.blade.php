            ...
            <form id="main-form" method="POST" action="">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <select class="form-control single-select" id="input-inventory-id" name="inventory_id">
                    ...
                    <div>
                        ...
                        <input type="number" class="form-control" name="quantity" id="input-qty" />
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control datepicker" name="dispatch_date"
                            id="input-dispatch-date" />
                    </div>

                    <div>
                        <label class="form-label">ETA</label>
                        <input type="text" class="form-control datepicker" name="estimated_time_of_arrival"
                            id="input-eta" />
                    </div>
                </div>
