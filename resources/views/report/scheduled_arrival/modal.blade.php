            ...
            <form id="main-form" method="POST" action="">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control daterangepicker" name="dispatch_date"
                            id="input-dispatch-date" />
                    </div>

                    <div>
                        <label class="form-label">ETA</label>
                        <input type="text" class="form-control daterangepicker" name="estimated_time_of_arrival"
                            id="input-eta" />
                    </div>
                </div>
