...
class CustomerController extends Controller
{
    public function get($id=null, Request $request)
    {
        ...
        if ($id != null) {
            $res = Customers::getById($id, $request);
        } else if (isset($request['all']) && $request['all']) {
            $res = Customers::getAllResult($request);
        } else {
            $res = Customers::getPaginatedResult($request);
        }
    ...
    {
        $params = $request->all();
        return Customers::createOrUpdate($params, $request->method(), $request);
    }
    ...
    public function put($id, Request $request)
    {
        $params = $request->all();
        $params['id'] = $id;
        return Customers::createOrUpdate($params, $request->method());
    }
    ...
    public function datatables(Request $request)
    {
        ...
        $res = Customers::datatables($start, $limit, $order, $dir, $search, $filter);
